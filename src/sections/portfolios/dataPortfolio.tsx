export const dataPortfolio = {
    Portfolio:[
        ...
        },
        {
            ...
            desc:'Nestled high on the eastern slopes of Mount Batukaru in Central Bali is Bali Mountain Paradise! Being situated in a traditional area of the central Bali mountains, Bali Mountain Retreat’s guests are given a unique experience with the local Balinese people and their culture.\n\nI started working here since 2020, and my task here is to fix their previous website design and also maintain it in the long run. I use Wordpress for the CMS, and Elementor as the UI Library.',
